...
<body>
	...
	<div class="categolis">
		<table>
			<tr>
				<th>
					<a href="haldi.php" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #e6b7b8;border-radius: 12px;">Haldi</a>
				</th>
				...
				<th><a href="jeera.php" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #24bfae;border-radius: 12px;">Jera Powder</a></th>
				...
				<th><a href="dryfruits.php" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #e6b7b8;border-radius: 12px;">Dry fruits</a></th>
				<th><a href="aboutus.php" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #e6b7b8;border-radius: 12px;">Expore More</a></th>
			</tr>
		</table>
	</div>
