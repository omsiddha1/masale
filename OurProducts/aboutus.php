	...
	<div class="categolis">
		<table>
			<tr>
				...
				<th><a href="aboutus.php" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #24bfae;border-radius: 12px;">Explore More</a></th>
			</tr>
		</table>
	</div>
							...
							<ul style="float: left;">
								<li style="float: left; padding: 0px 25px 25px 25px;">
									<div class="home-prodlist-img"><a href="view_product.php?pid='.$id.'">
										<img src="../image/product/hygiene/'.$picture.'" class="home-prodlist-imgi">
										</a>
