	...
	<div class="categolis">
		<table>
			<tr>
				...
				<th><a href="redchilli.php" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #e6b7b8;border-radius: 12px;">redchili</a></th>
				...
				<th><a href="kaju.php" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #24bfae;border-radius: 12px;">Kaju</a></th>
