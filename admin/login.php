		...
		<div class="homepageheader">
			<div class="signinButton loginButton">
				...
				<div class="uiloginbutton signinButton loginButton" style="">
					<a style="text-decoration: none; color: #fff;" href="http://localhost/masale/login.php">store</a>
				</div>
			</div>
							...
							<div>
								<form action="" method="POST" class="registration">
									<div class="signup_form">
										...
										<div>
											<td>
												<input name="password" id="password-1" required="required"  placeholder="Enter Password" class="password signupbox " type="password" size="30" value=""style="color:black;">
											</td>
										</div>
										<div>
