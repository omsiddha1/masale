			...
			if ($check == 0 ) {
				if ($email_check == 0) {
					if (strlen($_POST['password']) >1 ) {
						...
						<div class="signupform_text" style="font-size: 18px; text-align: center; color:black;">
						<font face="bookman">
							Email: '.$u_email.'<br>
	...
	<head>
		...
		<div class="homepageheader" style="position: inherit;">
			<div class="signinButton loginButton">
				...
				<div class="uiloginbutton signinButton loginButton" style="">
					<a style="text-decoration: none; color: #fff;" href="admin/login.php">admin panel</a>
				</div>
			</div>
							...
							<div>
								<div>
									<div class="signupform_content">
										<h2 style="color:red;">श्री गजानन मसाले</h2>
										...
										<div>
											<form action="" method="POST" class="registration">
												<div class="signup_form">
													<div>
														<td>
    														<input name="first_name" id="first_name" placeholder="First Name" required="required" class="first_name signupbox" type="text" size="30" value="'.$u_fname.'" style="color:black;">
														</td>

													</div>
													<div>
														<td >
															<input name="last_name" id="last_name" placeholder="Last Name" required="required" class="last_name signupbox" type="text" size="30" value="'.$u_lname.'" " style="color: black;">
														</td>
													</div>
													<div>
														<td>
															<input name="email" placeholder="Enter Your Email" required="required" class="email signupbox" type="email" size="30" value="'.$u_email.'"style="color:black;">
														</td
			>										</div>
													<div>
														<td>
															<input name="mobile" placeholder="Enter Your Mobile" required="required" class="email signupbox" type="text" size="30" value="'.$u_mobile.'"style="color:black;">
														</td>
													</div>
													<div>
														<td>
															<input name="signupaddress" placeholder="Write Your Full Address" required="required" class="email signupbox" type="text" size="30" value="'.$u_address.'"style="color:black;">
														</td>
													</div>
													<div>
														<td>
															<input name="password" id="password-1" required="required"  placeholder="Enter New Password" class="password signupbox " type="password" size="30" value="'.$u_pass.'"style="color:black;">
														</td>
													</div>
													<div>
														<input name="signup" class="uisignupbutton signupbutton" type="submit" value="Sign Me Up"style="color:red;">
													</div>
